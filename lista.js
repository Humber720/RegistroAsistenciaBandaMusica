document.addEventListener("DOMContentLoaded", () => {
  const estudiantes = [
    ...
    { nombre: "CRISTIAN KEVIN QUISPE MAMANI", grado: "PRIMERO" },
    { nombre: "GIORGIO MORIS CEREZO AUVIRI", grado: "PRIMERO" },
    { nombre: "AIRAN JUAN AYALA RODRIGUEZ", grado: "PRIMERO" },
    { nombre: "JOHAN ERLAN PEREZ GUTIERREZ", grado: "PRIMERO" },
    { nombre: "FABIAN CHAMBI GUTIERREZ", grado: "PRIMERO" },
    { nombre: "YERCO JHOEL MAMANI APAZA", grado: "PRIMERO" },
    { nombre: "JUAN RODRIGO MAYTA MAMANI", grado: "SEGUNDO" },
    { nombre: "KEVIN PATRICIO LUNA MERLO", grado: "SEGUNDO" },
    { nombre: "HANNA JANDY QUISPE GONZALES", grado: "SEGUNDO" },
    { nombre: "NEYMAR DIDYEL QUISPE MAMANI", grado: "SEGUNDO" },
    { nombre: "GENESIS CECILIA CHINO COYO", grado: "SEGUNDO" },
    { nombre: "JUAN DE DIOS CHAMBI GUTIERREZ", grado: "TERCERO" },
    { nombre: "FRANKLIN MAMANI CASTRO", grado: "TERCERO" },
    { nombre: "RAQUEL WARA ROQUE MENDOZA", grado: "TERCERO" },
    { nombre: "MELANI PILAR QUISPE MAMANI", grado: "TERCERO" },
    { nombre: "ALEJANDRA QUISPE MAMANI", grado: "TERCERO" },
    { nombre: "VICTOR FERNANDO VALVERDE SANCHEZ", grado: "TERCERO" },
    { nombre: "JAQUELINE VALERY MAYTA HERRERA", grado: "TERCERO" },
    { nombre: "JHONATAN DENNIS FLORES LOZA", grado: "TERCERO" },
    { nombre: "GUADALUPE TATIANA QUISPE CARRILLO", grado: "TERCERO" },
    { nombre: "YERCO PEREZ POMA", grado: "CUARTO" },
    { nombre: "ANDREA HINOJOSA QUISPE", grado: "CUARTO" },
    { nombre: "ARTURO ANDRES ROQUE MENDOZA", grado: "CUARTO" },
    { nombre: "LISED CASAS RAMOS", grado: "CUARTO" },
    { nombre: "MARIANELA RAMIREZ MENDOZA", grado: "CUARTO" },
    { nombre: "JHAMIL EDGAR GUZMAN COHARITE", grado: "CUARTO" },
    { nombre: "NOEL FIDEL MAYTA MAMANI", grado: "CUARTO" },
    { nombre: "RIVER CRISTIAN PAUCARA ILLANES", grado: "CUARTO" },
    { nombre: "DANER QUISPE QUISPE", grado: "QUINTO" },
    { nombre: "ANGEL CHAMBI GUTIERREZ", grado: "QUINTO" },
